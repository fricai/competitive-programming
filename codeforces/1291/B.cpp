...
template <class ForwardIterator>
  bool is_strictly_sorted (ForwardIterator first, ForwardIterator last)
{
...
bool solve() {
	...
	if (is_strictly_sorted(all(a)) || is_strictly_sorted(rall(a))) return true;
	return front_test(a) || back_test(a);
}
