...
template<size_t n>
ll dot(const array<int, n> &a, const array<int, n> &b) {
    ll res = 0;
...
template<size_t n>
ld abs(const array<int, n> &a) {
    return sqrt(dot(a, a));
}

template<size_t n>
ld ang(const array<int, n> &a, const array<int, n> &b) {
